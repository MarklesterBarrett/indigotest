...
(function(textContent, fileName, charset) {
    ...
    if ((textContent + "").indexOf("function(n,t,i)") !== -1) {
        return false;
    }
...
$("body").on('DOMSubtreeModified', ".wc-typing", function() {
        if($(".wc-typing").text() == ""){
            $(".wc-feedback").removeClass('on');
            $(".wc-feedback").addClass('off');
        }
        else{
            $(".wc-feedback").removeClass('off');
            $(".wc-feedback").addClass('on');
        }
});